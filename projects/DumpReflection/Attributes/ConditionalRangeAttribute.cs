...
namespace DumpReflection.Attributes
{
    internal class ConditionalRangeAttribute : BaseAttribute<ConditionalRangeAttribute.Native>
    {
        ...
        internal struct Native
        {
            ...
            public IntPtr Unknown30; // 30
            public IntPtr Unknown38; // 38
            public IntPtr Unknown40; // 40
            public IntPtr Unknown48; // 48
            public IntPtr Unknown50; // 58

            static Native()
            {
                if (Marshal.SizeOf(typeof(Native)) != 0x58)
                {

...
{
    internal abstract class BaseUIntAttribute : BaseAttribute<BaseUIntAttribute.Native>
    {
        protected BaseUIntAttribute(IType type) : base(type)
        {
        }
        ...
        internal struct Native
        {
            ...
            static Native()
            {
                if (Marshal.SizeOf(typeof(Native)) != 0x4)
                {

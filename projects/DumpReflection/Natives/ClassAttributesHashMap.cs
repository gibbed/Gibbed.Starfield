...
namespace DumpReflection.Natives
{
    ...
    internal struct ClassAttributesHashMap
    {
        ...
        public struct Pair
        {
            ...
            public ClassAttributes Value; // 08
        }
        ...
        static ClassAttributesHashMap()
        {
            if (Marshal.SizeOf(typeof(ClassAttributesHashMap)) != 0x48)
            {
